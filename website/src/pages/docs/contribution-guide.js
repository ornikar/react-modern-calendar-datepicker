  ...
  return (
    <Docs title="Contribution Guide">
      ...
      <ul className="Docs__list">
        <li>1- Submit <a className="Docs__link" rel="noopener noreferrer" href="https://github.com/ornikar/react-modern-calendar-datepicker/issues">an issue </a> for what you want to work on</li>
        <li>2- After approval, fork the <a rel="noopener noreferrer" target="_blank" className="Docs__link" href="https://github.com/ornikar/react-modern-calendar-datepicker"> Github repository </a></li>
